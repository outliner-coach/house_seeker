...
| Completed | P1 | Add Korean-first bilingual UI support | locale provider, translated shell copy, and locale-aware smoke test | Default locale is Korean and English can be toggled at sign-in and in-app |
